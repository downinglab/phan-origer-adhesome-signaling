# Figure 5 scVelo RNA velocity analysis
# By Andrew Phan
...
# Need to convert to h5ad
adata = sc.read_h5ad('~/converted-combined.h5ad')

# load loom files for spliced/unspliced matrices for each sample:
ldata1 = scv.read('~/D6LacZ/possorted_genome_bam_7MVG3_D6LacZ.loom', cache=True)
ldata2 = scv.read('~/D6S3/possorted_genome_bam_GHOLO_D6S3.loom', cache=True)
ldata3 = scv.read('~/D9LacZ/possorted_genome_bam_EZ311_D9LacZ.loom', cache=True)
ldata4 = scv.read('~/D9S3/possorted_genome_bam_JLBHK_D9S3.loom', cache=True)
ldata5 = scv.read('~/D12LacZ/possorted_genome_bam_9IE2M_D12LacZ.loom', cache=True)
ldata6 = scv.read('~/D12S3/possorted_genome_bam_3WJ73_D12S3.loom', cache=True)
ldata7 = scv.read('~/D15LacZ/possorted_genome_bam_1QLD5_D15LacZ.loom', cache=True)
ldata8 = scv.read('~/D15S3/possorted_genome_bam_8JWL0_D15S3.loom', cache=True)
